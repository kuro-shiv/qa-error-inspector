# TODO: Fix QA Error Inspector Issues

## Tasks
- [x] Modify panel.js to fetch and display all API requests, not just errors
- [x] Update applyFilters to work on all displayed requests (.request class)
